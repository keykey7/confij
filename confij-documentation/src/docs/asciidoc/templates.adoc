...
One use case is to disable templating per propertiy.
...
Implementing a custom templating engine and registering it on a property per annotation.
The custom resolver must have an empty constructor.
