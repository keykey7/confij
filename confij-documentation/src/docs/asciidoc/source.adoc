...
[source]
----
include::{src}[tag=anysource,indent=0]
----
...
[source]
----
include::{src}[tag=nestedinterface,indent=0]
----
----
include::{home}/nested.properties[]
----

<1> Per default, nested configurations are separated with a dot form each other.
